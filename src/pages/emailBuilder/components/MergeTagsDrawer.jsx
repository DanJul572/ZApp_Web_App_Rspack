...
const MergeTagsDrawer = ({
  ...
  return (
    ...
    >
        ...
        >
          ...
          <Box>
            ...
            <Typography
              ...
              mt={0.3}
            >
              Tambahkan tag lalu ketik <strong>{'{{nama_tag}}'}</strong> di
              dalam email editor. Kolom harus sesuai dengan nama kolom hasil SQL
              di primary/optional source.
            </Typography>
          </Box>
        </Paper>
            ...
            {value.map((tag, index) => (
              ...
              >
                ...
                >
                  ...
                  <Box sx={{ display: 'flex', gap: 0.5 }}>
                    {tag.tag && (
                      <Tooltip
                        title={
                          copied === tag.tag ? 'Copied!' : `Copy {{${tag.tag}}}`
                        }
                      >
                        <IconButton
                          size="small"
                ...
                >
                  ...
                  />
                  <TextField
                    label="Nama Kolom SQL"
                    placeholder="contoh: customer_name"
                    size="small"
                    fullWidth
                    value={tag.column}
                    onChange={(e) =>
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      handleFieldChange(tag.id, 'defaultValue', e.target.value)
                    }
                    sx={{ gridColumn: '1 / -1' }}
                  />
                </Box>
                  ...
                  >
                    ...
                    {tag.column && (
                      <Typography
                        ...
                        ml={1}
                      >
                        → kolom: <strong>{tag.column}</strong>
                      </Typography>
                    )}
                  </Box>
                )}
      ...
      >
        <Typography variant="caption" color="text.secondary">
          {value.length} tag{value.length !== 1 ? 's' : ''} configured
        </Typography>
